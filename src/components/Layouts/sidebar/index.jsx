...
export function Sidebar({ isAdminPage }) {
          ...
          <div className="relative pr-4.5">
            ...
            {isMobile && (
              ...
              >
                ...
                <CloseIcon className="ml-auto size-7" />
              </button>
            )}
          </div>

          {isMobile && (
            <h2 className="m-2 flex items-center gap-2 text-sm font-medium text-dark-4 dark:text-dark-6">
